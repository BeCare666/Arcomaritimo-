...
function displayOrders(orders, validated) {
  ...
  userArray.forEach(order => {
    ...
    var actionIcon = status 
      ...
      : `<a href="facture.html?product_link_id=${order.Idproduct} "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
