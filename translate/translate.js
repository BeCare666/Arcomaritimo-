$(document).ready(function() {
    ...
    it: {
      ...
      "INDEXID12": "Emergenza",
      "INDEXID13": "",
      "INDEXID14XXX": "Il tuo partner affidabile per soluzioni complete e di qualità in importazione, logistica, transito, spedizione e noleggio.",
      ...
      "INDEXID21": "Arcomaritimo, il tuo partner di fiducia per la realizzazione dei tuoi progetti e la fornitura di servizi di alto livello, Arcomaritimo opera in 199 paesi in tutto il mondo. Siamo presenti in ogni paese. Le nostre navi servono tutti i porti del mondo. Effettuiamo cinque affitti al mese e serviamo oltre 329 porti in tutto il globo, con una flotta di 450 portacontainer per una capacità totale di 2,1 milioni di EVP. Offriamo anche servizi di cabotaggio marittimo e trasporto fluviale.",
      ...
      "INDEXID38": "Offriamo una vasta gamma di container, nuovi e usati, in vendita o in affitto, adatti alle vostre esigenze specifiche.",
  ...
  es: {
    translation: {
      ...
      "INDEXID13": "",
      "INDEXID14XXX": "Tu socio confiable para soluciones completas y de calidad en importación, logística, tránsito, consignación y alquiler.",
      ...
      "INDEXID38": "Ofrecemos una amplia gama de contenedores nuevos y usados para la venta o alquiler, adaptados a sus necesidades específicas.",
  ...
  pt: {
    translation: {
      ...
      "INDEXID13": "",
      "INDEXID14XXX": "Seu parceiro confiável para soluções completas e de qualidade em importação, logística, trânsito, consignação e aluguel.",
      "INDEXID15": "Sobre <i class=\"bi bi-arrow-right\"></i>",
      ...
      "INDEXID38": "Oferecemos uma ampla gama de contêineres novos e usados para venda ou aluguel, adaptados às suas necessidades específicas.",
  ...
  translation: {
    ...
    "INDEXID12": "طوارئ",
    "INDEXID13": "",
    "INDEXID14XXX": "شريككم الموثوق لحلول شاملة وذات جودة في استيراد، والخدمات اللوجستية، والعبور، والقنصلية، والإيجار.",
    ...
    "INDEXID38": "نقدم مجموعة واسعة من الحاويات الجديدة والمستعملة للبيع أو الإيجار، تناسب احتياجاتكم الخاصة.",
...
tr:{
  translation:{
    ...
    "INDEXID13": "",
    "INDEXID14XXX": "İthalat, lojistik, transit, konşimento ve kiralama konularında kaliteli ve kapsamlı çözümler için güvenilir iş ortağınız.",
    ...
    "INDEXID38": "İhtiyacınıza uygun yeni ve kullanılmış konteynerlerin geniş bir yelpazesini kiralama veya satış için sunuyoruz.",
